Pod::Spec.new do |s|
    ...
    s.screenshots = ['https://raw.github.com/agassiyzh/MWPhotoBrowser/' \
                     'master/Preview/MWPhotoBrowser1.png',
                     'https://raw.github.com/agassiyzh/MWPhotoBrowser/' \
    ...
    s.homepage = 'https://github.com/agassiyzh/MWPhotoBrowser'
    s.author = { 'Michael Waterfall' => 'michaelwaterfall@gmail.com' }
    s.source = {
        :git => 'https://github.com/agassiyzh/MWPhotoBrowser.git',
        :tag => '1.2.1.1'
    }
